...
description(parents(conceptId('Systolic heart failure')))
...
# To list all the attributes of a concept:
...
description(relatedConcepts(conceptId('Heart failure'), conceptId('Finding site')))

# Disorders with a 'Finding site' of 'Heart'
description(relatedConcepts(conceptId('Heart'), conceptId('Finding site'),
	reverse = TRUE))
```
