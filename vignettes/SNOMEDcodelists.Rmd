...
- codelist_name (can be specified as an argument to the SNOMEDcodelist function)
- author (can be specified as an argument to the SNOMEDcodelist function)
- version (can be specified as an argument to the SNOMEDcodelist function)
- date (can be specified as an argument to the SNOMEDcodelist function)
...
print(single_row_maps[, list(term = substr(term, 1, 10), read2_code, ctv3_concept)])
