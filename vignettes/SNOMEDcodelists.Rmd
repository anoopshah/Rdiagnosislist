...
The sample SNOMED dictionary included in this package does not include all these attributes, so the following example requires a full SNOMED CT dictionary to be loaded.
